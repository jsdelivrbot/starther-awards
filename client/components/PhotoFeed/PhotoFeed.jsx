    ...
    <div className="photo-feed">
        <ul className="cards">
            <Card
                ...
                title="Coffee shop"
            />
            <Card imgSrc="https://unsplash.it/600/600?image=1061" />
            <Card imgSrc="https://unsplash.it/600/600?image=1062" />
            <Card imgSrc="https://unsplash.it/600/600?image=1063" />
            <Card imgSrc="https://unsplash.it/600/600?image=1064" />
